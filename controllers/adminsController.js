      ...
      html: `
        <div style="max-width: 600px; margin: auto; padding: 20px; font-family: Arial, sans-serif; line-height: 1.6; color: #333; border: 1px solid #ddd; border-radius: 8px; box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.1);">
          ...
          <div style="text-align: center; margin: 20px 0;">
            <a href="https://doms-front-end.vercel.app/" style="display: inline-block; padding: 12px 24px; background-color: #4CAF50; color: #fff; text-decoration: none; font-size: 16px; border-radius: 5px;">Login to Your Account</a>
          </div>
          <p>If you did not request this verification, please contact our support team immediately.</p>
          <hr style="border: 1px solid #ddd; margin: 20px 0;" />
          <p style="text-align: center; font-size: 14px; color: #888;">Best Regards,<br><strong>Dynamic Order Management System Team</strong><br><a href="https://doms-front-end.vercel.app/" style="color: #555; text-decoration: none;">Visit Our Website</a></p>
        </div>
      `,
    });
    ...
    await transport.sendMail({
      ...
      html: /*HTML*/ `
        <div style="max-width: 600px; margin: auto; padding: 20px; font-family: Arial, sans-serif; line-height: 1.6; color: #333; border: 1px solid #ddd; border-radius: 8px; box-shadow: 0px 4px 8px rgba(0, 0, 0, 0.1);">
          ...
          <div style="text-align: center; margin: 20px 0;">
            <a href="https://doms-front-end.vercel.app/login" style="display: inline-block; padding: 12px 24px; background-color: rgb(134, 34, 210); color: #fff; text-decoration: none; font-size: 16px; border-radius: 5px;">Login to Your Account</a>
          </div>
